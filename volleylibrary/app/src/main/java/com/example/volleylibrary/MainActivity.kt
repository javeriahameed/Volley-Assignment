...
class MainActivity : AppCompatActivity() {
    ...
    private fun Request_Image()
    {
        ...
        val queue= Volley.newRequestQueue(this)
        val url="https://cdn.pixabay.com/photo/2018/01/14/23/12/nature-3082832_960_720.jpg"
    ...
    private fun Add_JSONArrayRequest() {
        ...
        val view: TextView =findViewById(R.id.ViewBox)
        val queue= Volley.newRequestQueue(this)
        val url = "https://run.mocky.io/v3/7859dd0f-6baf-4c7a-946b-9ad87e62b3a6"
        val params = HashMap<String,String>()
        params["name"] = "Javeria Hameed"
        params["Class"] = "BSE-7B"
        params["Reg_No"] = "FA18-BSE-0180"
        val jsonObject = JSONObject(params as Map<*, *>)
